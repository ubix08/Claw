...
4. Supply the key to clawd — add to `~/.clawd/clawd.json`:
   ```json
   {
     "skills": {
       "entries": {
...
node {baseDir}/search.js "query" -n 10                                # More results (max 20)
node {baseDir}/search.js "query" --content                            # Include page content as markdown
node {baseDir}/search.js "query" --freshness pw                       # Results from last week
node {baseDir}/search.js "query" --freshness 2024-01-01to2024-06-30  # Date range
node {baseDir}/search.js "query" --country DE                         # Results from Germany
